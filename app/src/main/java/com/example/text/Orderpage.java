    ...
    public void AddData() {
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isinserted == true) {
                    Toast.makeText(Orderpage.this, "Your Order Has Been Received", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(Orderpage.this, "Something went wrong", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
